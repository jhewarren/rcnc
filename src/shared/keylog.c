 ...
 *		and find device number for keyboard item | grep -E "Name|Handlers" | more
 *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
